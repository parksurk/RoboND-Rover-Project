...
def perception_step(Rover):
    ...
    # is not the postion of the rover but a bit in front of it
    ...
    obstacle_x_world, obstacle_y_world = pix_to_world(obstacle_xpix, obstacle_ypix, Rover.pos[0], Rover.pos[1], Rover.yaw, world_size, scale)
    ...
    if(rock_map.any()):
        ...
        Rover.vision_image[:,:,1] = rack_map= 255
    else:
